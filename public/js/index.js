...
// scene.canvas.width = parentDiv.offsetWidth;
// scene.canvas.height = parentDiv.offsetHeight;

const textureLoader = new THREE.TextureLoader()
const myTexture = textureLoader.load('/Texture/coolTex.jpg')

// Object
const geometry = new THREE.BoxGeometry(0.1,0.1,0.1)
const geometry2 = new THREE.DodecahedronGeometry(0.1,3)
